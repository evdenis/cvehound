...
@pytest.mark.notbackported(
    ...
    [
        ...
        ('CVE-2022-42719', 'stable/linux-5.15.y'),
        ('CVE-2022-42719', 'stable/linux-5.10.y'),
        ('CVE-2022-42719', 'stable/linux-5.4.y'),
        ('CVE-2022-42720', 'stable/linux-5.15.y'),
        ('CVE-2022-42720', 'stable/linux-5.10.y'),
        ('CVE-2022-42720', 'stable/linux-5.4.y'),
        ('CVE-2022-3521', 'stable/linux-5.15.y'),
        ('CVE-2022-3521', 'stable/linux-5.10.y'),
        ('CVE-2022-3521', 'stable/linux-5.4.y'),
        ('CVE-2022-3521', 'stable/linux-4.19.y'),
        ('CVE-2022-3521', 'stable/linux-4.14.y'),
        ('CVE-2022-3521', 'stable/linux-4.9.y'),
    ]
)
